			...
			<FAQWrapper>
				<CustomAccordion defaultActiveKey={["0"]} flush>
					<Accordion.Item eventKey="0">
						...
						<Accordion.Body>
							<AccordionBody>
								...
								'현장실습 디지털 핵심 실무인재 양성훈련'으로 <br />
								디지털 신기술을 활용한 프로젝트 기반의 실무 중심 훈련과정입니다.
							</AccordionBody>
						</Accordion.Body>
					</Accordion.Item>
					<Accordion.Item eventKey="1">
						...
						<Accordion.Body>
							<AccordionBody>
								...
								불가능합니다.
								<br />
								국비지원이 가능한지 여부는 고용센터에 문의해주시기 바랍니다.
							</AccordionBody>
						</Accordion.Body>
					</Accordion.Item>
					...
					<Accordion.Item eventKey="4">
						...
						<Accordion.Body>
							<AccordionBody>
								훈련과정 중에 취업이 되면 훈련을 중도에 포기할 수 있습니다.{" "}
								<br />
					...
					<Accordion.Item eventKey="5">
						...
						<Accordion.Body>
							<AccordionBody>
								네, 수료 이후에도 한국소프트웨어기술진흥협회(KOSTA)의{" "}
								<u>취업지원센터</u>가 있습니다.
								<br />
								취업지원센터에서는 이력서 및 자기소개서 작성, 면접 준비 등
								다양한 취업 지원 서비스를 제공하고 있습니다. <br />
